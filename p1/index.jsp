          ...
          fields: {
            ...
            street: {
              validators: {
                ...
                regexp: {
                  //street: must only contain letters, numbers, commas, space characters, hyphens, or periods
                  regexp: /^[a-zA-Z0-9,\-\s\.]+$/,
                  message:
                    "Street can only contain letters, numbers, commas, hyphens, or periods",
                },
              },
            },
            ...
            city: {
              validators: {
                ...
                regexp: {
                  //city can only contain letters, numbers, hyphens, and space character
                  regexp: /^[a-zA-Z0-9\-\s]+$/,
                  message:
                    "City can only contain letters, numbers, hyphens, and space character",
                },
            ...
            state: {
              validators: {
                ...
                regexp: {
                  //city can only only contain two letters
                  regexp: /^[a-zA-Z]+$/,
            ...
            balance: {
              validators: {
                ...
                stringLength: {
                  ...
                  max: 7,
                  message:
                    "Balance can be no more than 6 digits, including decimal point",
                },
                regexp: {
                  //must only contain numbers
                  regexp: /^[0-9\.]+$/,
            ...
            total_sales: {
              validators: {
                ...
                stringLength: {
                  ...
                  max: 7,
                  message:
                    "Total sales can be no more than 6 digitd, including decimal point",
                },
                regexp: {
                  //must only contain numbers
                  regexp: /^[0-9\.]+$/,
                  message:
                    "Total sales can only contain numbers and decimal point",
                },
              },
            },
          },
