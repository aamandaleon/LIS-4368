...
<!-- can also find path like this...<a href="${pageContext.request.contextPath}${'/a5/index.jsp'}">A5</a> -->	
	...
	<div class="container">
		<div class="starter-template">
					...
					<form id="add_customer_form" method="post" class="form-horizontal" action="${pageContext.request.contextPath}/testInput">
				...
				lname: {
					...
					City: {
							validators: {
									...
									regexp: {
										regexp: /^[a-zA-Z0-9\-\s]+$/,
										message: 'City can only contain letters, numbers, space character, and hyphens'
									},									
							},
					},
